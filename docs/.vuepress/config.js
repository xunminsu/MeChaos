...
module.exports = {
  ...
  title: "MeChao's blog",
  description: 'web开发技术博客,专注web开发学习与总结。Python, Django, Flask, JavaScript, Vue等技术文章。',
  base: '/MeChaos/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
